import { BaseLinkIcon } from '..';
import { LINKEDIN } from '../../utils/constants';

export function LinkedinLink() {
  return (
    <BaseLinkIcon href={LINKEDIN} aria-label="Linkedin Link" id="linkedin" viewBox="-1 0.5 18 18" invertOnHover>
      <mask id="mask-linkedin" className="*:transition-all *:duration-300">
        <rect height="98%" width="98%" x="-0.8" y="0.75" />
      ...
      <g mask="url(#mask-linkedin)">
        <rect height="98%" width="98%" x="-0.8" y="0.75" id="linkedin-inverse" />
        <path
          id="linkedin"
