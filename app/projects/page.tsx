    ...
    <Page>
      <DescriptionBlock
        ...
        <DescriptionWithImage
          ...
          image={
            <>
              <rect className="fill-slate-800" height="100%" width="100%" clipPath="url(#types-hot-parser)" />
              <path
                strokeWidth="0"
      ...
      <DescriptionBlock title="Personal Projects" titleProps={{ className: 'font-semibold' }}>
        <DescriptionWithImage
          ...
          image={
            <image
              className="h-[100px] w-[98px] grayscale"
              xlinkHref="/ree-wallpaper.webp"
              clipPath="url(#ree-optimization)"
            />
          }
        ...
        <DescriptionWithImage
          ...
          image={
            <image className="h-[100px] w-[102.5px] grayscale" xlinkHref="/holydays.webp" clipPath="url(#holydays)" />
          }>
          <DescriptionBlock
            samanticTitleTag="h3"
            className="[&&]:mt-0"
